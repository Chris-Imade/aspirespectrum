  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    hoverBtns.forEach(hoverBtn => {
      hoverBtn.addEventListener('mouseenter', () => {
        ...
        document.querySelectorAll('.vs-team.active').forEach(el => el.classList.remove('active'));
        document.querySelectorAll('.vs-team__share--hover.active').forEach(el => el.classList.remove('active'));
        document.querySelectorAll('.vs-team__share--list.active').forEach(el => el.classList.remove('active'));

        // Add 'active' to the current group
    ...
    // Remove 'active' when mouse leaves the .vs-team
    const teamBoxes = document.querySelectorAll('.vs-team');
    teamBoxes.forEach(teamBox => {
      teamBox.addEventListener('mouseleave', () => {
        teamBox.classList.remove('active');
        const hoverBtn = teamBox.querySelector('.vs-team__share--hover');
        const shareList = teamBox.querySelector('.vs-team__share--list');

        if (hoverBtn) hoverBtn.classList.remove('active');
        if (shareList) shareList.classList.remove('active');
      });
    });
  });
